...
def main():
    ...
    train_dataset.extend(aug_train_dataset)
    val_dataset.extend(aug_val_dataset)

    print(
        f"size of the total trainning set after augmentation: {len(train_dataset)}")
    print(
        f"size of the total validation set after augmentation: {len(val_dataset)}")

    with open("data/train_aug.pkl", "wb") as aug_train:
        pickle.dump(train_dataset, aug_train)

    with open("data/val_aug.pkl", "wb") as aug_val:
        pickle.dump(val_dataset, aug_val)
