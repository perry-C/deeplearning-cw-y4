...
parser.add_argument("--learning-rate", default=1e-2,
...
parser.add_argument("--data-aug-hflip",
                    action="store_true",
                    )
parser.add_argument("--data-aug-brightness",
                    default=0,
                    type=float
                    )
...
class CNN(nn.Module):
    def __init__(self, height: int, width: int, channels: int, class_count: int):
        ...
        # initialise some batch normalisation layer
        ...
        self.norm3 = nn.BatchNorm1d(self.fc1.out_features)
